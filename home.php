...
<body style="background-color: yellow">
	...
	<div>
	<center><h1>improve your speed in maths</h1></center>
	</div>
			...
			<div class="col-md-6">
               ...
               ?>
					...
					<div id ="dataresults" style="margin-left: 30px;display:none">
						...
						<div id="results" style="margin-left: 30px;font-size: 180%">
						</div>
					</div>
					<div id="maindata" style="display: none;">
						<center>
							<input  class="dem" type="text" id="dem1" value="0">
							 <span id="typevalue">?</span>
							<input class="dem" type="text" id="dem2" value="0">
						</center>
							<br>
							<br>
							<br>
							<center>
							<span id="typevalue">1)</span><input style="font-size: 180%"  type="submit" class="button" id="first" value="0">
							<span id="typevalue">2)</span><input style="font-size: 180%" type="submit" class="button" id="second" value="0">
							<span id="typevalue">3)</span><input style="font-size: 180%" type="submit" class="button" id="third" value="0">
							<span id="typevalue">4)</span><input style="font-size: 180%" type="submit" class="button" id="fourth" value="0">
						</center>
							<br>							
						</div>
			</div>
